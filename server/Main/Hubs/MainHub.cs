...
namespace Main.Hubs
{
    public class MainHub : Hub
    {
        ...
        public async Task EndGame(Chat chat, string color)
        {
            ...
            {
                if (color != null) await SendMessage(currentUser.Username, chat, $"{currentUser.Username} won the the game.", false);    
                else await SendMessage(currentUser.Username, chat, $"{currentUser.Username} left the game.", false);
